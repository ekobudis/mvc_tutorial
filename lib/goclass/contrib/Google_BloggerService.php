 ...
 */
  ...
  /**
   * The "ppdbs" collection of methods.
   * Typical usage is:
   *  <code>
   *   $bloggerService = new Google_BloggerService(...);
   *   $ppdbs = $bloggerService->ppdbs;
   *  </code>
   */
  class Google_PagesServiceResource extends Google_ServiceResource {
    ...
    /**
     * Retrieves ppdbs for a blog, possibly filtered. (ppdbs.list)
     *
     * @param string $blogId ID of the blog to fetch ppdbs from.
     * @param array $optParams Optional parameters.
     *
    ...
    /**
     * Gets one blog page by id. (ppdb.get)
     *
...
class Google_BloggerService extends Google_Service {
  ...
  public function __construct(Google_Client $client) {
    ...
    $this->pages = new Google_PagesServiceResource($this, $this->serviceName, 'ppdb', json_decode('{"methods": {"list": {"scopes": ["https://www.googleapis.com/auth/blogger", "https://www.googleapis.com/auth/blogger.readonly"], "parameters": {"fetchBodies": {"type": "boolean", "location": "query"}, "blogId": {"required": true, "type": "string", "location": "path"}}, "id": "blogger.ppdbs.list", "httpMethod": "GET", "path": "blogs/{blogId}/ppdbs", "response": {"$ref": "PageList"}}, "get": {"scopes": ["https://www.googleapis.com/auth/blogger", "https://www.googleapis.com/auth/blogger.readonly"], "parameters": {"pageId": {"required": true, "type": "string", "location": "path"}, "blogId": {"required": true, "type": "string", "location": "path"}}, "id": "blogger.ppdbs.get", "httpMethod": "GET", "path": "blogs/{blogId}/ppdbs/{pageId}", "response": {"$ref": "Page"}}}}', true));
