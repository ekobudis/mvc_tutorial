 ...
 */
  ...
  class Google_CseServiceResource extends Google_ServiceResource {
     ...
     * @opt_param string relatedSite Specifies that all search results should be ppdbs that are related to the specified URL
     ...
     * @opt_param string siteSearch Specifies all search results should be ppdbs from a given site
